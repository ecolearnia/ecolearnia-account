...
var ACCOUNT_FK = 'AccountUuid';

//var SYSID_COLUMN = '_id';
//var ACCOUNT_FK = 'account';
 ...
 *
 */
internals.AuthManager = function(persistenceProvider)
{
...
internals.AuthManager.prototype.SYSID_COLUMN = function()
{
  return SYSID_COLUMN;
}

internals.AuthManager.prototype.ACCOUNT_FK = function()
{
  return ACCOUNT_FK;
}
...
internals.AuthManager.prototype.createAccountAndAuth = function(account, auth)
{
    var promise = promiseutils.createPromise(function(resolve, reject) {
        ...
        .then(function(accountModel) {
            auth.account = accountModel[SYSID_COLUMN];
            this.add(auth)
...
internals.getManager = function(persistenceProviderName)
{
    if (!internals.managerInstance)
    {
      ...
      var persistenceProvider = require(persistenceProviderPath);
        ...
        internals.managerInstance = new internals.AuthManager(persistenceProvider);
    }
