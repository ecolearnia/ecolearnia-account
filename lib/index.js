...
exports.register = function(server, options, next) {
    ...
    var accountResource = new HapiResource(settings.pathBase + internals.CONST.API_PREFIX, 'accounts', internals.accountManager, criteriaKeyDictionary);
    ...
    server.route({
        ...
        method: 'PUT',
        handler: function(request, reply) {
            var error = exception.createNotImplementedError(null);
            reply(unauthorizedError.toJSON()).status(error.statusCode);
        }
    });
                ...
                config: {
                    ...
                    handler: function (request, reply) {
                        ...
                        .then(function(authenticated) {
                            ...
                            var redirUrl = request.query.redir_url || settings.authRedir;
