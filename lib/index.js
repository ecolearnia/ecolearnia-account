...
var GoogleAuthHelper = require('./utils/gogleauthhelper').GoogleAuthHelper;
...
exports.register = function(server, options, next) {
    ...
    var authResource = new HapiResource(settings.pathBase, 'auth', authManager, criteriaKeyDictionary);
                ...
                config: {
                    ...
                    handler: function (request, reply) {
                        ...
                        .then(function(matchAuth) {
                            ...
                            return accountManager.createAccountAndAuth(account, authCredential);
                        })
                        .then(function(auth) {
